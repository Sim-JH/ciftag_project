...
#     mode: str = Query(default='both', title="필터링 방식", description="tag/both"),
#     tags: List[str] = Query(title="다운로드 대상 tag"),
#     sample_zip: Optional[UploadFile] = File(
#         default=None, title="샘플 이미지 파일", description="샘플 이미지를 zip파일 형태로 제공. 일정한 사이즈(오차 10%내외)의 이미지 권장"
#     ),
...
#         zip_path = None
#
#     return download_image_by_tags_service(mode, tags, zip_path, target_size, threshold)
