...
class TumblrCrawlInfo(Base, CrawlInfoDataMixin):
    """텀블러 크롤링 수행 정보"""

    __tablename__ = "tumb_crawl_info"
...
class TumblrCrawlData(Base, ImgDataImgDataMixin):
    """텀블러 크롤링 데이터"""

    __tablename__ = "tumb_crawl_data"

    id = Column(Integer, primary_key=True)  # 인덱스
    tumb_pk = Column(Integer)  # 텀블러 정보 ID (FK)
